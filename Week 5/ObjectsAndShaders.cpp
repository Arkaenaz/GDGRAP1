...
int main(void)
{
    ...
    unsigned char* tex_bytes = stbi_load("3D/venlumi.png", &img_width, &img_height, &colorChannels, 0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //transformation_matrix = glm::rotate(transformation_matrix, glm::radians(theta), glm::vec3(0, fRY, 0));
